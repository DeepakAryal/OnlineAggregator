...
class ResultUnavailableCest
{
    ...
    public function testKaymuHeading(AcceptanceTester $I)
    {
    ...
    public function testMunchaHeading(AcceptanceTester $I)
    {
    ...
    public function testSastoDealHeading(AcceptanceTester $I)
    {
